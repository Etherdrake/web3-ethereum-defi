...
def fetch_pool_details(web3, pool_contact_address: Union[str, HexAddress]) -> PoolDetails:
    ...
    pool = get_deployed_contract(web3, "pancakeswap_v3/Pancake3Pool.json", pool_contact_address)
...
def get_raw_fee_from_pool_address(web3, pool_contract_address: HexAddress):
    ...
    pool = get_deployed_contract(web3, "pancakeswap_v3/Pancake3Pool.json", pool_contract_address)
